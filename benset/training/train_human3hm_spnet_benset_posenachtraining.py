...
start_lr = 0.001
weights_path = os.path.join("E:\\Bachelorarbeit-SS20\\weights\\deephar\\output\\ntu_baseline\\0603", 'weights_posebaseline_{epoch:03d}.hdf5')
...
penn_sf = PennAction("D:\\PennAction", pennaction_dataconf,
